...
error_flag = cmor.setup(inpath='./mip_cmor_tables/out/', netcdf_file_action=cmor.CMOR_REPLACE)

error_flag = cmor.dataset_json("my_input.json")
#error_flag = cmor.dataset_json("CMOR_input_example.json")

cmor.load_table("CMIP6Plus_OPmon.json")
itim = cmor.axis(
    table_entry='time',
